    ...
    <div class="relative" @click.away = "show = false">
        <div>
            <div class="twa-form-input-container">
                <div
                    class="relative focus:ring-primary-600  focus-within:ring-primary-600 flex rounded-md ring-1  transition focus-within:ring-2 dark:ring-dark-600 dark:text-dark-300 text-gray-600 ring-gray-300 dark:bg-dark-800 form-input-element">
                    <div class=" text-[12px] min-h-[36px] flex items-center pl-3 pr-0 dark:placeholder-dark-400  w-full rounded-md border-0 bg-transparent py-1.5 cursor-pointer"
                        x-on:click="show = !show" x-text="'Choose images (' + uploaded.length + ' uploaded) '">

                    </div>
                    <span
                        class="ml-1  dark:text-dark-400 absolute top-0 bottom-0 right-[16px] flex select-none items-center whitespace-nowrap z-10">
                        <button type="button">
